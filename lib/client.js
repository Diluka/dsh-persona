...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /** @typedef {{ checked: boolean, onChange: (checked: boolean) => void, label: string, disabled?: boolean }} DshSwitchProps */
    const { IconChevronDownOutline14, Switch } = /** @type {{ IconChevronDownOutline14: import("react").ComponentType<{ className?: string }>, Switch: import("react").ComponentType<DshSwitchProps> }} */ (require("@deepseek-ai/dsh-client-ui-primitives"));
